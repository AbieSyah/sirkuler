...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="nav-menu">
                <a href="Dashboard_Awal.php" class="nav-link">Beranda</a>
                <a href="Lihat_Limbah_Pertanian_1.php" class="nav-link active">Limbah Pertanian</a>
    ...
    <script>
        ...
        const products = [
            ...
            },
            {
                ...
                image: 'Tongkol jagung Organik.jpg',
            ...
            },
            {
                ...
                image: 'Batang Jagung Kering.jpg',
                location: 'Lampung',
                stock: '42 Ton',
                moisture: '11%',
                price: 380000,
            ...
            },
            {
                ...
                image: 'Batang Singkong Premium.jpg',
        ...
        function renderProducts() {
            ...
            grid.innerHTML = products.map(product => `
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=${encodeURIComponent(product.name)}&image=${encodeURIComponent(product.image)}&price=${product.price}&location=${encodeURIComponent(product.location)}'">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-actions">
                            <button class="btn-add-cart" onclick="event.stopPropagation(); addToCart(${product.id})">+ Keranjang</button>
