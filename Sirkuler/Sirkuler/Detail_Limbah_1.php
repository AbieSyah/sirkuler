...
<body>
        ...
        <div class="product-detail-grid">
            ...
            <div class="product-image-section">
                <div class="main-product-image">
                    <img id="detailImage" src="https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=600&q=80" alt="Product Image">
    ...
    <script>
        ...
        // Handle dynamic content from URL parameters
        window.addEventListener('DOMContentLoaded', () => {
            ...
            if (imgParam) {
                document.getElementById('detailImage').src = imgParam;
            }
            if (nameParam) {
                document.querySelector('.product-title').textContent = nameParam;
                document.title = nameParam + ' - Sirkuler';
                // Update breadcrumb
                const breadcrumb = document.querySelector('.breadcrumb');
                if (breadcrumb) {
                    breadcrumb.innerHTML = `<a href="Dashboard_Awal.php">Beranda</a> / <a href="Lihat_Limbah_Pertanian_1.php">Limbah Pertanian</a> / ${nameParam}`;
                }
            }
            if (priceParam) {
                document.querySelector('.price-current').textContent = 'Rp ' + parseInt(priceParam).toLocaleString('id-ID');
            }
            if (locParam) {
                // Find the location element (it's the first meta-item span:nth-child(2))
                const metaItems = document.querySelectorAll('.meta-item span');
                for (let i = 0; i < metaItems.length; i++) {
                    if (metaItems[i].textContent.includes('Jawa') || metaItems[i].textContent.includes('Sumatra') || metaItems[i].textContent.includes('Lampung')) {
                        metaItems[i].textContent = locParam;
                        break;
                    }
                }
            }
