...
<body>
        ...
        <div class="order-summary">
            ...
            <div class="order-items">
                <div class="order-item">
                    <img src="limbah jerami padi.jpg" class="item-img" alt="Jerami Padi">
                ...
                <div class="order-item">
                    <img src="pupuk cair.jpg" class="item-img" alt="Pupuk Cair">
                    <div class="item-detail">
                        <div class="item-name">Pupuk Cair Organik</div>
                        <div class="item-qty">3 Botol × Rp 75.000</div>
                    </div>
                    <div class="item-price">Rp 225.000</div>
                </div>

                <div class="order-item">
                    <img src="briket.jpg" class="item-img" alt="Briket">
                    <div class="item-detail">
    ...
    <script>
        ...
        function processPayment() {
            ...
            setTimeout(() => {
                window.location.href = 'Pembayaran_Berhasil.php';
            }, 2000);
        }
