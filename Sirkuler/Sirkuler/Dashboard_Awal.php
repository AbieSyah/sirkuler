...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <div class="logo-section" onclick="window.location.href='Dashboard_Awal.php'">
            ...
            <div class="nav-menu">
                <a href="Dashboard_Awal.php" class="nav-link active">Beranda</a>
                <a href="Lihat_Limbah_Pertanian_1.php" class="nav-link">Limbah Pertanian</a>
                <a href="Lihat_Produk_Olahan_1.php" class="nav-link">Produk Olahan</a>
                <a href="Keranjang.php" class="nav-link">Transaksi</a>
    ...
    <div class="main-content">
        ...
        <div class="popular-products">
            ...
            <div class="products-grid">
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Jerami%20Padi%20Premium&image=limbah%20jerami%20padi.jpg&price=750000&location=Karawang,%20Jawa%20Barat'">
                    <div class="product-image">
                        <img src="limbah jerami padi.jpg" alt="Jerami Padi">
                    </div>
                ...
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Sekam%20Padi%20Grade%20A&image=Sekam%20Padi%20Grade%20A.jpg&price=450000&location=Demak,%20Jawa%20Tengah'">
                    <div class="product-image">
                        <img src="Sekam Padi Grade A.jpg" alt="Sekam Padi">
                    </div>
                    <div class="product-info">
                ...
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Tongkol%20Jagung%20Organik&image=Tongkol%20Jagung%20Organik.jpg&price=600000&location=Kediri,%20Jawa%20Timur'">
                    <div class="product-image">
                        <img src="Tongkol Jagung Organik.jpg" alt="Tongkol Jagung">
                    </div>
                    <div class="product-info">
                ...
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Batang%20Singkong%20Premium&image=Batang%20Singkong%20Premium.jpg&price=520000&location=Bogor,%20Jawa%20Barat'">
                    <div class="product-image">
                        <img src="Batang Singkong Premium.jpg" alt="Batang Singkong">
                    </div>
                    <div class="product-info">
        ...
        <div class="popular-products">
            ...
            <div class="products-grid">
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Sekam%20Padi&image=sekam%20padi.webp&price=75000&location=Malang,%20Jawa%20Timur'">
                    <div class="product-image">
                        <img src="sekam padi.webp" alt="Sekam Padi">
                    </div>
                    <div class="product-info">
                        <h3 class="product-name">Sekam Padi</h3>
                        <div class="product-location">📍 Malang, Jawa Timur</div>
                        <div class="product-price">Rp 75.000 <span style="font-size: 14px; color: #718096;">/package</span></div>
                        <button class="product-btn">Lihat Detail</button>
                    </div>
                </div>

                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Briket%20Biomassa&image=briket.jpg&price=85000&location=Lampung'">
                    <div class="product-image">
                        <img src="briket.jpg" alt="Briket Biomassa">
                    </div>
                    <div class="product-info">
                ...
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Pupuk%20Cair%20Organik&image=pupuk%20cair.jpg&price=45000&location=Bandung,%20Jawa%20Barat'">
                    <div class="product-image">
                        <img src="pupuk cair.jpg" alt="Pupuk Cair">
                    </div>
                    <div class="product-info">
                ...
                <div class="product-card" onclick="window.location.href='Detail_Limbah_1.php?name=Pakan%20Fermentasi%20Ternak&image=pakan2.jpg&price=180000&location=Boyolali,%20Jawa%20Tengah'">
                    <div class="product-image">
                        <img src="pakan2.jpg" alt="Pakan Ternak">
                    </div>
                    <div class="product-info">
